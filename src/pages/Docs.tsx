...
const sections: DocSection[] = [
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
        ...
        <p>
          ArcLend borrows its lending mechanics from the well-established patterns of Aave �: u: u: u: u: u: u: u: u: utilization-driven interest rates, over-collateralized borrowing, and a transparent liquidation framework. It extends     </p>
        <p>
