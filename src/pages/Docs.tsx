...
const sections: DocSection[] = [
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
        <p>
          ArcLend is a decentralized financial protocol built for the Rialo Network. It provides a unified platform where users can lend and borrow assets, swap tokens, supply liquidity to trading pools, stake governance tokens, and monitor their portfolio health, intermediaries or custodians.
        </p>
        <p>
        ...
        <p>
          ArcLend borrows its lending mechanics from the well-established patterns of Aave �: u: u: u: utilization-driven interest rates, over-collateralized borrowing, and a transparent liquidation framework. It extendsaking features that make it a self-contained DeFi layer for Rialo.
        </p>
        <p>
